<?php
     ...
     */
    if ( $Employees->validatePermission( "customParamsGroup-add", $userInfo->role_id ) !== true ) returnResponse( "Access denied", 403 );
    ...
    /**
     * Cоздание группы кастомных параметров
     */


    $groupId = $DB->makeCustomParamsGroup( $request->data->title );
    ...
    $History->addLog(
        ...
        " ) добавил группу кастомных параметров ( " . $request->data->title . " )", "info",
