<?php
     ...
     */
    if ( $Employees->validatePermission( "customParamsGroup-change", $userInfo->role_id ) !== true ) returnResponse( "Access denied", 403 );
    ...
    $History->addLog(
        ...
        " ) редактировал группу кастомных параметров ( " . $request->data->id . " )", "info",
