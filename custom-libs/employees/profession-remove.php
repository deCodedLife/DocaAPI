<?php
     ...
     */
    if ( $Employees->validatePermission( "profession-remove", $userInfo->role_id ) !== true ) returnResponse( "Access denied", 403 );
     ...
     */
    if ( !$Employees->removeProfession( $request->data->id ) ) returnResponse( "Something was wrong", 500 );
    ...
    $History->addLog(
        ...
        " ) удалил профессию ( " . $request->data->id . " )", "info", 
