<?php
     ...
     */
    if ( $Employees->validatePermission( "fine-remove", $userInfo->role_id ) !== true ) returnResponse( "Access denied", 403 );
     ...
     * Удаление штрафа
     */
    if ( !$Fines->removeFine( $request->data->id ) ) returnResponse( "Something was wrong", 500 );
    ...
    $History->addLog(
        ...
        " ) удалил штраф ( " . $request->data->id . " )", "info", 
